<section id="top">
		...
		<div class="rightside">
			...
			<ul class="submenu">
				<li class="sub-hilited patient_info_form"><a href="javascript: void(0);" onclick="javascript: loadPatientInformation();">Patient Information</a></li>
				<li>I</li>
				<li class="medical_history_form"><a href="javascript: void(0);" onclick="javascript: loadMedicalHistory();">Medical History</a></li>
			</ul>
		</div>
