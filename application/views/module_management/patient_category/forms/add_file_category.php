<script>
	...
	$(function(){
    	...
    	$(".form_new_files_category_list").live('change', function(e) {
			if($(this).val()) {
...
<section class="area">
	...
	<section id="left">
			<form action="<?php echo url('module_management/add_file_category') ?>" method="post" id="add_new_category_form" style="width:100%;">

				<ul id="form02">
					<li>File Category Name <span>*</span></li>
					<li><input type="text" id="category_name" name="category_name" class="textbox validate[required] form_new_files_category_list" style="margin: 0px;"></li>
				</ul>
				...
				<ul id="form02">
					<li>Status</li>
					<li>
						<select name="status" id="status" class="select form_new_files_category_list" style="width: 100px;">
