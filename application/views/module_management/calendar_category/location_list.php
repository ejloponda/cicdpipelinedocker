...
<!--
	$(function() {
		...
		$('#location_list_dt').dataTable({
			...
			"bServerSide": true,
			"iDisplayLength": 10,
			"sAjaxSource": base_url + "module_management/getAllLocationList?",
...
<section class="area">
	<hgroup id="area-header">
		<ul class="page-title">
			...
			<li><h1><span id="dosage_list_form">Location</span></h1></li>
			...
			<button class="button01 add_location_type">+ Add Location</button>
		<div class="clear"></div>

	</hgroup>
	
	
	<table id="location_list_dt" class="datatable table" style="min-width: 85%;">
	    <thead>
		<tr>
			<th valign="top" width="30%" style="text-align: center;">Location</th>
