...
<!--
	$(function() {
		...
		$('#disease_list_dt').dataTable({
			...
			"bServerSide": true,
			"iDisplayLength": 10,
			"sAjaxSource": base_url + "module_management/getAllDoctorsList?",
...
<section class="area">
	<hgroup id="area-header">
		<ul class="page-title">
			...
			<li><h1><span id="doctors_list">Doctors</span></h1></li>
			<!-- <li><h1> <span class="not-hilited" id="disease_category">Disease Category</span> <span>:</span> <span class="not-hilited" id="disease_type">Disease Type</span> <span>:</span> <span id="doctors_list">Doctors</span> <span>:</span> <span class="not-hilited" id="files_category_list">Files Category</span></h1></li> -->
		</ul>
		<?php if($mm_dc['can_add']){ ?>
			<button class="button01 get_doctors_form">+ Add Doctor</button>
		<?php } ?>
		<div class="clear"></div>
	...
	<table id="disease_list_dt" class="datatable table" style="min-width: 85%;">
	    <thead>
		<tr>
			<th valign="top" width="20%" style="text-align: center;">Doctors Name</th>
