<script>
	<!--
	$(function(){
		$("#add_cost_modifier_form").validationEngine({scroll:false});
		$("#add_cost_modifier_form").ajaxForm({
        success: function(o) {
      		if(o.is_successful) {
...
<section class="area">
	<hgroup id="area-header">
		...
		<ul id="controls">
			<li><a href="javascript: void(0);" onclick="$('#add_cost_modifier_form').submit();"><img class="icon" src="<?php echo BASE_FOLDER; ?>themes/images/icon_save.png"></a></li>
	...
	<section id="left">
			<form action="<?php echo url('module_management/save_cost_modifier') ?>" method="post" id="add_cost_modifier_form" style="width:100%;">
					<ul id="form">
						<li>Cost Modifier</li>
						<li>
							<input type="input" name="cost_modifier" id="cost_modifier" class="textbox form_charges" style="width: 200px;">
						</li>
					</ul>
	...
	<section class="clear"></section>
	<section id="buttons">
		<button class="form_button" onClick="$('#add_cost_modifier_form').submit();">Save & Continue</button>
