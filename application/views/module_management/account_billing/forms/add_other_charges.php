	...
	<section id="left">
			<form action="<?php echo url('module_management/save_other_charges') ?>" method="post" id="add_other_charges_form" style="width:100%;">
					<ul id="form">
						...
						<li>
							<input type="input" name="r_centers" id="r_centers" class="textbox form_charges validate[required]" style="width: 200px;">
						</li>
					</ul>
				...
				<ul id="form02">
					...
					<li>
						<select name="category" id="category" class="select form_charges validate[required]" style="width: 130px;">
							...
							<option value="yp">Your Prevention Test</option>
							<option value="armin">Armin Test</option>
						</select>
					</li>
				</ul>
				...
				<ul id="form">
					<li>Price</li>
					<li>
						<input type="input" name="price" class="textbox form_charges" style="width: 100px;" placeholder='0.00'>
					</li>
				</ul>
