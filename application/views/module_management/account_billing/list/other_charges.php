...
<!--
	$(function() {
		...
		$('#other_charges_list_dt').dataTable({
			...
			"bServerSide": true,
			"iDisplayLength": 10,
			"sAjaxSource": base_url + "module_management/getAllOtherChargesList?",
...
<section class="area">
	<hgroup id="area-header">
		<ul class="page-title">
			...
			<li><h1><span class="" id="other_charges_list">Other Charges</span><!--  <span>:</span> --> </h1></li>
		</ul>
		<?php if($mm_oc['can_add']){ ?>
			<button class="button01 add_other_charges">+ Add Other Charges</button>
		<?php } ?>
		<div class="clear"></div>
	...
	<table id="other_charges_list_dt" class="datatable table" style="min-width: 85%;">
	    <thead>
		<tr>
			<th valign="top" width="20%" style="text-align: center;">Revenue Centers</th>
