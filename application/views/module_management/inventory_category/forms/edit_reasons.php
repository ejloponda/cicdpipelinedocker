	...
	<section id="left">
			<form action="<?php echo url('module_management/add_reasons') ?>" method="post" id="add_reasons_form" style="width:100%;">
					<ul id="form">
						<li>Reasons</li>
						<li>
							<input type="hidden" name="reasons_id" value="<?php echo $reasons['id'] ?>">
							<textarea name="reasons" class="form_reasons textbox" style="max-height: 100px;height:100px;max-width: 220px;"><?php echo $reasons['reason'] ?></textarea>
						</li>
					</ul>
					...
					<ul id="form02">
						...
						<li>
							<select name="status" id="status" class="select form_reasons" style="width: 100px;">
								<option value="Active" <?php echo ($reasons['status'] == "Active" ? "selected" : "") ?>>Active</option>
								<option value="Inactive" <?php echo ($reasons['status'] == "Inactive" ? "selected" : "") ?>>Inactive</option>
							</select>
						</li>
					</ul>
