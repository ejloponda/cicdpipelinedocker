<script>
	$(function(){
		...
		$("#add_new_returns_form").validationEngine({scroll:false});
		$("#add_new_returns_form").ajaxForm({
	        success: function(o) {
	      		if(o.is_successful) {
...
<section class="area">
	<hgroup id="area-header">
		<ul class="page-title">
			...
			<li><h1>Return Inventory</h1></li>
		</ul>
		
		<ul id="controls">
			<li><a href="javascript:void(0);" onClick="$('#add_new_returns_form').submit();"><img class="icon" src="<?php echo BASE_FOLDER; ?>themes/images/icon_save.png"></a></li>
	...
	<form action="<?php echo url("inventory_management/saveNewReturns") ?>" method="post" id="add_new_returns_form"  style="width:100%;">
			...
			<h1>Basic Information</h1>
							...
							<li>
								...
								<select id="medicine_source" class="validate[required]" style="display:none">
								  ...
								  <?php foreach($medicines as $key=>$value): ?>
								  	<?php $dosage = Dosage_Type::findById(array("id" => $value['dosage_type'])); ?>
								    <option value="<?php echo $value['id']; ?>"><?php echo $value['medicine_name'] . " " . $value['dosage'] . " " . $dosage['abbreviation'] ?></option>
								  <?php endforeach; ?>
								</select>
							</li>				
						</ul>
					<section class="clear"></section>
						...
						<ul id="form">
							...
							<li><input type="text" name="generic_name" id="generic_name" class="textbox add_returns_trigger validate[required]" readonly></li>
						</ul>
					...
					<section class="clear"></section>
						...
						<ul id="form">
							...
							<li>
								<input type="text" name="dosage" id="dosage" class="textbox add_returns_trigger validate[required,custom[number]]" style="width: 70px;" readonly>
								<input type="text" name="dosage_type" id="dosage_type" class="textbox add_returns_trigger validate[required]" style="width: 70px;" readonly>
							</li>
						</ul>	
					<section class="clear"></section>
		</section>
		<section id="right">
			<h1>Stock Information</h1>
						<ul id="form">
							<li>Quantity:</li>
							<li>
								<input type="text" name="quantity" id="quantity" class="textbox add_returns_trigger validate[required,custom[number]]" style="width: 70px;" readonly>
								<input type="text" name="quantity_type" id="quantity_type" class="textbox add_returns_trigger validate[required]" style="width: 70px;" readonly>
							</li>
						</ul>	
		...
		<section id="left" style="border-right: dashed 1px #d3d3d3;">
			<h1>Miscellaneous Details</h1>
				<ul id="form">
					<li>Purchase Date</li>
					<li><input type="text" id="purchase_date" name="purchase_date" class="textbox add_returns_trigger" readonly></li>
				</ul>
			...
			<section class="clear"></section>
				...
				<ul id="form">
					...
					<li><input type="text" id="expiration_date" name="expiration_date" class="textbox add_returns_trigger" readonly></li>
				</ul>
		</section>
		<section id="right">
			...
			<ul id="form">
				...
				<li>
					...
					<!-- <input type="text" name="returned_by_name" class="textbox validate[required] add_returns_trigger" autocomplete="on" style="width: 220px;"> -->
				</li>
			</ul>
		...
		<section class="clear"></section>
			...
			<ul id="form">
					...
					<li>
						<input type="text" name="returns_quantity" class="textbox add_returns_trigger validate[required,custom[number]]" style="width: 70px;">
						<input type="text" name="returns_quantity_type" id="returns_quantity_type" class="textbox add_returns_trigger validate[required]" style="width: 70px;" readonly>
						<!-- <select name="returns_quantity_type" id="returns_quantity_type" class="select validate[required]" style="width: 70px;">
			...
			<ul id="form">
				...
				<li><textarea type="text" name="returns_reason" class="validate[required] add_returns_trigger"></textarea></li>
			</ul>
		...
		<section id="buttons">
			<button class="form_button" onClick="$('#add_new_returns_form').submit();">Save & Continue</button>
