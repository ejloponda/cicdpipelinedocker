					...
					<div class="tab-pane" id="breakfast_form">
						...
						// debug_array($value['med_ops']);
							foreach ($value['med_ops'] as $c => $d) {
								...
								$sub_wrapper 		 = "breakfast_sub_wrapper_{$count}_{$index}";
						?>
							<div class="<?php echo $sub_wrapper ?>">
								<ul id="form" class="<?php echo $div_wrapper ?>">
									...
									<li>
										...
										<input type="hidden" name="<?php echo $id ?>" value="<?php echo $d['medicine_id'] ?>">
										&nbsp;<a href='javascript: void(0);' class='btn btn-xs btn-danger' onclick='javascript: deleteElementRow("<?php echo $sub_wrapper ?>");' style='height: 20px;'><i class='glyphicon glyphicon-minus'></i></a>
									</li>				
								</ul>
								<section class="clear <?php echo $div_wrapper ?>"></section>
								<ul id="form" class="<?php echo $div_wrapper ?>">
						...
						<!-- <button type="button" class="btn btn-xs btn-danger"><i class='glyphicon glyphicon-minus'></i> Return</button></button>  -->
							...
							<section class="clear <?php echo $div_wrapper ?>"></section>
							<button type="button" class="btn btn-xs btn-danger <?php echo $div_wrapper ?>" onclick="javascript: delSaveMedicine('<?php echo $div_wrapper ?>')"><i class='glyphicon glyphicon-minus'></i> Delete</button></button> 
							<section class="clear <?php echo $div_wrapper ?>"></section>
						<?php $count++; } ?>
					...
					<div class="tab-pane" id="lunch_form">
						...
						<?php
							...
							foreach ($value['med_ops'] as $c => $d) {
								...
								$sub_wrapper 		 = "lunch_sub_wrapper_{$count}_{$index}";
						?>
						<div class="<?php echo $sub_wrapper ?>">
							<ul id="form" class="<?php echo $div_wrapper ?>">
								<li>Medicine Name: <span>*</span></li>
						...
						<!-- <button type="button" class="btn btn-xs btn-danger"><i class='glyphicon glyphicon-minus'></i> Return</button></button>  -->
							...
							<section class="clear <?php echo $div_wrapper ?>"></section>
							<button type="button" class="btn btn-xs btn-danger <?php echo $div_wrapper ?>" onclick="javascript: delSaveMedicine('<?php echo $div_wrapper ?>', <?php echo  $d['id'] ?>)"><i class='glyphicon glyphicon-minus'></i> Delete</button></button> 
							<section class="clear <?php echo $div_wrapper ?>"></section>
						<?php $count++; } ?>
					...
					<div class="tab-pane" id="dinner_form">
						...
						// debug_array($value['med_ops']);
							foreach ($value['med_ops'] as $c => $d) {
								...
								$sub_wrapper 		 = "dinner_sub_wrapper_{$count}_{$index}";
						?>
							<div class="<?php echo $sub_wrapper ?>">
								<ul id="form" class="<?php echo $div_wrapper ?>">
									<li>Medicine Name: <span>*</span></li>
									<li>
										...
										<script>
											$(function(){ getMedicineQuantityType('<?php echo $index ?>', 'ed'); });
