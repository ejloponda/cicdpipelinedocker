...
<table class="table-regimen datatable" style="width: 96%;">
	...
	<tr>
		...
		<td style="width: 10%; vertical-align:middle;">
			<a href="javascript: void(0);" onClick="javascript: edit_regimen_record(<?php echo $key ?>);" class="table_icon" original-title="Edit"><i class="glyphicon glyphicon-edit"></i></a>
			...
			<span style="margin: 0 5px 0 5px; text-align: center;"><img src="<?php echo BASE_FOLDER ?>themes/images/line.png"></span>
			<a href="javascript:void(0);" onclick="javascript: duplicate_rowDB(<?php echo $value['id'] ?>);" class="table_icon" original-title="Duplicate Row"><i class="glyphicon glyphicon-repeat"></i></a>
		</td>
	</tr>
	<?php } ?>
