...
<div class="modal-dialog" style="width:50%; word-wrap:normal;">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 id="myModalLabel"><img src="<?php echo BASE_FOLDER; ?>themes/images/header-lock.png"> Scope & Module</h4>
	  </div>
	  <div class="modal-body">
	  	<form action="<?php echo url('admin/saveModuleScope') ?>" id="add_module_scope_form" method="post" style="width: 100%;">
	  		<section id="role-input">
		  		Scope <span>*</span> <br/>
				<input type="text" name="scope" class="textbox validate[required]" placeholder="Scope">
			</section>
			<br />
			<section id="role-input">
		  		Module <span>*</span> <br/>
				<input type="text" name="module" class="textbox validate[required]" placeholder="Module">
			</section>
			<br/>
			<section id="form">
				Status <br/>
