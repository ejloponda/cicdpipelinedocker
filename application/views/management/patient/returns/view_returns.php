<section class="area">
	<hgroup id="area-header">
		...
		<ul id="controls">
			...
			<?php } ?>
			<li><a href="javascript:void(0);" onclick="javascript: view_return_list();" class="cancel_receipt"><img class="icon actions" title="Back" src="<?php echo BASE_FOLDER; ?>themes/images/icon_cancel.png"></a></li>
		</ul>
		...
		<tbody>
			<?php foreach ($medicines as $key => $value) { ?>
				<tr>
					...
					<td><?php echo $value['quantity'] . " " . $value['quantity_type'] ?></td>
	...
	<ul id="form02">
		<li>Notes</li>
		<li><?php echo $collections['notes'] ?></li>
	</ul>
</section>
