			...
			<div class="col-md-12 add-test-input-wrapper with-border">
				...
				<?php if($category == 'urinalysis'){ ?>
					<div id="urinalysis" class="col-md-12 urinalysis-input-hldr category-input-wrapper no-padding">
						...
						<div class="col-md-2 select-input-wrapper">
							<label>RBC</label>
							<input type="text" name="microscopic_rbc" value="<?php echo $data_labtest['microscopic_rbc']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
						...
						<div class="col-md-2 select-input-wrapper">
							<label>HYALINE</label>
							<input type="text" name="hyaline" value="<?php echo $data_labtest['hyaline']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>FINE GRANULAR</label>
							<input type="text" name="fine_granular" value="<?php echo $data_labtest['fine_granular']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>COARSE GRANULAR</label>
							<input type="text" name="coarse_granular" value="<?php echo $data_labtest['coarse_granular']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>RBC CAST</label>
							<input type="text" name="rbc_cast" value="<?php echo $data_labtest['rbc_cast']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>WBC CAST</label>
							<input type="text" name="wbc_cast" value="<?php echo $data_labtest['wbc_cast']; ?>" >
						</div>
						<div class="clear"></div>
						<hr class="custom-hr">
						<h6>CAST</h6>
						<div class="col-md-2 select-input-wrapper">
							...
							<input type="text" name="calcium_oxalates" value="<?php echo $data_labtest['calcium_oxalates']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>URIC ACID</label>
							<input type="text" name="uric_acid" value="<?php echo $data_labtest['uric_acid']; ?>" >
						</div>
						<div class="col-md-2 select-input-wrapper">
							<label>HIPPURIC ACID</label>
							<input type="text" name="hippuric_acid" value="<?php echo $data_labtest['hippuric_acid']; ?>" >
						</div>
					</div>
				<?php } ?>
					...
					<div id="hormones" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper">
						<div class="col-md-6 border-right">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="testosterone" value="<?php echo $data_labtest['testosterone']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
								<input type="text" name="testosterone_unit" value="<?php echo $data_labtest['testosterone_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>reference value</label>
								<input type="text" name="testosterone_rf" value="<?php echo $data_labtest['testosterone_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
								<label>FREE TESTOSTERONE (CLIA)</label>
								<input type="text" name="free_testosterone" value="<?php echo $data_labtest['free_testosterone']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
								<input type="text" name="free_testosterone_unit" value="<?php echo $data_labtest['free_testosterone_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>reference value</label>
								<input type="text" name="free_testosterone_rf" value="<?php echo $data_labtest['free_testosterone_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
								<label>Sex Hormone Binding Globulin (SHBG) (CLIA)</label>
								<input type="text" name="shbg" value="<?php echo $data_labtest['shbg']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
								<input type="text" name="shbg_unit" value="<?php echo $data_labtest['shbg_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>reference value</label>
								<input type="text" name="shbg_rf" value="<?php echo $data_labtest['shbg_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="aldosterone" value="<?php echo $data_labtest['aldosterone']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
								<input type="text" name="aldosterone_unit" value="<?php echo $data_labtest['aldosterone_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>reference value</label>
								<input type="text" name="aldosterone_rf" value="<?php echo $data_labtest['aldosterone_rf']; ?>" >
								<ul class="sub-note">
						...
						<div class="col-md-6">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="c_peptide" value="<?php echo $data_labtest['c_peptide']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
								<input type="text" name="c_peptide_unit" value="<?php echo $data_labtest['c_peptide_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>reference value</label>
								<input type="text" name="c_peptide_rf" value="<?php echo $data_labtest['c_peptide_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="post_prandial" value="<?php echo $data_labtest['post_prandial']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>unit</label>
					...
					<div id="tumor_markers" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper">
						<div class="col-md-6 border-right">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="afp" value="<?php echo $data_labtest['afp']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="afp_unit" value="<?php echo $data_labtest['afp_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="afp_rf" value="<?php echo $data_labtest['afp_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="ca_15_3" value="<?php echo $data_labtest['ca_15_3']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="ca_15_3_unit" value="<?php echo $data_labtest['ca_15_3_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="ca_15_3_rf" value="<?php echo $data_labtest['ca_15_3_rf']; ?>" >
							</div>
							<div class="clear"></div>
						</div>
						<div class="col-md-6">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="cyfra_21_1_clia" value="<?php echo $data_labtest['cyfra_21_1_clia']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="cyfra_21_1_clia_unit" value="<?php echo $data_labtest['cyfra_21_1_clia_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="cyfra_21_1_clia_rf" value="<?php echo $data_labtest['cyfra_21_1_clia_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
								<label>TOTAL PSA  (CLIA)</label>
								<input type="text" name="total_psa" value="<?php echo $data_labtest['total_psa']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="total_psa_unit" value="<?php echo $data_labtest['total_psa_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="total_psa_rf" value="<?php echo $data_labtest['total_psa_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
								<label>FREE PSA  (CLIA)</label>
								<input type="text" name="free_psa" value="<?php echo $data_labtest['free_psa']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="free_psa_unit" value="<?php echo $data_labtest['free_psa_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="free_psa_rf" value="<?php echo $data_labtest['free_psa_rf']; ?>" >
							</div>
							<div class="clear"></div>
							<div class="col-md-4 select-input-wrapper">
								<label>Free: Total PSA Ratio</label>
								<input type="text" name="total_psa_ratio" value="<?php echo $data_labtest['total_psa_ratio']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="total_psa_ratio_unit" placeholder="%" value="<?php echo $data_labtest['total_psa_ratio_unit']; ?>" >
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="total_psa_ratio_rf" value="<?php echo $data_labtest['total_psa_ratio_rf']; ?>" >
