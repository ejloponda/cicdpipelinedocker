...
<section class="area patient-dashboard-section">
	<form action="<?php echo url('patient_management/add_new_labtest') ?>" method="post" id="add_new_labtest_form"  style="width:100%;">	
				...
				<div class="input-wrapper-add">
					<div class="col-md-12 descript-input-hldr no-padding for-lab-test">
						...
						<div id="urinalysis" class="col-md-12 urinalysis-input-hldr category-input-wrapper no-padding">
							...
							<div class="col-md-2 select-input-wrapper">
								<label>HYALINE</label>
								<input type="text" name="hyaline">
							</div>
							<div class="col-md-2 select-input-wrapper">
								<label>FINE GRANULAR</label>
								<input type="text" name="fine_granular">
							</div>
							<div class="col-md-2 select-input-wrapper">
								<label>COARSE GRANULAR</label>
								<input type="text" name="coarse_granular">
							</div>
							<div class="col-md-2 select-input-wrapper">
								<label>RBC CAST</label>
								<input type="text" name="rbc_cast">
							</div>
							<div class="col-md-2 select-input-wrapper">
								<label>WBC CAST</label>
								<input type="text" name="wbc_cast">
							</div>
							<div class="clear"></div>
							<hr class="custom-hr">
							<h6>CAST</h6>
							<div class="col-md-2 select-input-wrapper">
								...
								<input type="text" name="calcium_oxalates">
							</div>
							<div class="col-md-2 select-input-wrapper">
							...
							<div class="col-md-2 select-input-wrapper">
								...
								<input type="text" name="hippuric_acid">
							</div>
						</div>
						...
						<div id="coagulation" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper two-col-wrapper" style="display:none">
							<div class="col-md-6 border-right">
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="prothrombin_time">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="prothrombin_time_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="prothrombin_time_rf">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>CONTROL</label>
								...
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="control_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="control_rf">
								</div>
								<div class="col-md-4 select-input-wrapper">
								...
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="inr_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="inr_rf">
								</div>
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="percentage_activity">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="percentage_activity_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="percentage_activity_rf">
								</div>
							</div>
							<div class="col-md-6">
								<div class="col-md-4 select-input-wrapper">
									<label>ACTIVATED PARTIAL</label>
									<input type="text" name="activated_partial">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="activated_partial_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="activated_partial_rf">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>THROMBOPLASTIN TIME (APTT)</label>
									<input type="text" name="thromboplastin_time">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="thromboplastin_time_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="thromboplastin_time_rf">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>CONTROL</label>
									<input type="text" name="aptt_control">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="aptt_control_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="aptt_control_rf">
								</div>
							</div>
						</div>
						...
						<div id="hematology" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper" style="display:none">
							<div class="col-md-6 border-right padding-bottom">
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="blood_typing_with_rh">
								</div>
								<div class="col-md-4 select-input-wrapper">
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="rh_typing">
								</div>
							</div>
							<div class="col-md-6 padding-bottom">
								<div class="col-md-4 select-input-wrapper">
									<label>RETICULOCYTE COUNT</label>
									<input type="text" name="reticulocyte_count">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="reticulocyte_count_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="reticulocyte_count_rf">
								</div>
							</div>
						...
						<div id="biochemistry" class="col-md-12 bio-input-hldr no-padding category-input-wrapper" style="display:none">
							...
							<div class="col-md-12 no-padding">
								...
								<div class="col-md-2 select-input-wrapper border-right">
									<label>reference value</label>
									<input type="text" name="magnesium_si_rf">
									<ul class="sub-note">
						...
						<div id="hormones" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper" style="display:none">
							<div class="col-md-6 border-right">
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="testosterone">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
									<input type="text" name="testosterone_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>reference value</label>
									<input type="text" name="testosterone_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
									<label>FREE TESTOSTERONE (CLIA)</label>
									<input type="text" name="free_testosterone">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
									<input type="text" name="free_testosterone_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>reference value</label>
									<input type="text" name="free_testosterone_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
									<label>Sex Hormone Binding Globulin (SHBG) (CLIA)</label>
									<input type="text" name="shbg">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
									<input type="text" name="shbg_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>reference value</label>
									<input type="text" name="shbg_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="aldosterone">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
									<input type="text" name="aldosterone_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>reference value</label>
									<input type="text" name="aldosterone_rf">
									<ul class="sub-note">
							...
							<div class="col-md-6">
								...
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
									<input type="text" name="c_peptide_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>reference value</label>
									<input type="text" name="c_peptide_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
						...
						<div id="serology" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper" style="display:none">
							<div class="col-md-6 border-right">
								...
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="ferritin_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
						...
						<div id="tumor_markers" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper" style="display:none">
							<div class="col-md-6 border-right">
								...
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="afp_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="afp_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="ca_15_3">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="ca_15_3_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="ca_15_3_rf">
								</div>
								<div class="clear"></div>
							</div>
							<div class="col-md-6">
								...
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="cyfra_21_1_clia">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="cyfra_21_1_clia_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="cyfra_21_1_clia_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
									<label>TOTAL PSA  (CLIA)</label>
									<input type="text" name="total_psa">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="total_psa_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="total_psa_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
									<label>FREE PSA  (CLIA)</label>
									<input type="text" name="free_psa">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="free_psa_unit">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="free_psa_rf">
								</div>
								<div class="clear"></div>
								<div class="col-md-4 select-input-wrapper">
									<label>Free: Total PSA Ratio</label>
									<input type="text" name="total_psa_ratio">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>UNIT</label>
									<input type="text" name="total_psa_ratio_unit" placeholder="%">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>REFERENCE VALUE</label>
									<input type="text" name="total_psa_ratio_rf">
						...
						<div id="special_chem" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper" style="display:none">
							...
							<div class="col-md-6">
								<div class="col-md-4 select-input-wrapper">
									...
									<input type="text" name="NT-proBNP">
								</div>
								<div class="col-md-4 select-input-wrapper">
									<label>unit</label>
		...
		<div class="col-md-12 save-cancel-btn-wrapper" style="display: block;">
			<button type="button" class="def-btn view-records-btn add_submit_btn">Submit</button>
...
$(document).on('change', '.file', function(){
  $(this).parent().find('.form-control.file-name').val($(this).val().replace(/C:\\fakepath\\/i, ''));
});

    var counter = 0;
    $('.add-file-input').click(function () {
        var elems =  '<div class="form-group file-input-group">'+
						    '<input type="file" name="img[]" class="file">'+
						    '<div class="input-group col-xs-12">'+
						      '<span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>'+
						      '<input type="text" class="form-control file-name input-lg" disabled placeholder="Select Image">'+
