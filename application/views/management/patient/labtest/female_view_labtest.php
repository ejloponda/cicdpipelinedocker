			...
			<div class="col-md-12 descript-input-hldr no-padding">
				...
				<?php if($category == 'urinalysis'){ ?>
					<div id="urinal-wrapper" class="col-md-12 urinalysis-input-hldr category-input-wrapper no-padding">
						...
						<div class="col-md-3 select-input-wrapper">
							<label>RBC</label>
							<input type="text" name="rbc" value="<?php echo $data_labtest['microscopic_rbc'];?>" disabled>
						</div>
						<div class="col-md-3 select-input-wrapper">
					...
					<div id="hormones" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper">
						<div class="col-md-6 border-right">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="total_testosterone" value="<?php echo $data_labtest['total_testosterone']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="total_testosterone_unit" value="<?php echo $data_labtest['total_testosterone_unit']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="total_testosterone_rf" value="<?php echo $data_labtest['total_testosterone_rf']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
						...
						<div class="col-md-6">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="post_prandial" value="<?php echo $data_labtest['post_prandia']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="osteocalcin" value="<?php echo $data_labtest['osteocalcin']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="osteocalcin_unit" value="<?php echo $data_labtest['osteocalcin_unit']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="osteocalcin_rf" value="<?php echo $data_labtest['osteocalcin_rf']; ?>" disabled>
								<ul class="sub-note">
					...
					<div id="tumor_markers" class="col-md-12 hematology-input-hldr no-padding category-input-wrapper">
						<div class="col-md-6 border-right">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="ca_125" value="<?php echo $data_labtest['ca_125']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="ca_125_unit" value="<?php echo $data_labtest['ca_125_unit']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="ca_125_rf" value="<?php echo $data_labtest['ca_125_rf']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
						...
						<div class="col-md-6">
							...
							<div class="col-md-4 select-input-wrapper">
								...
								<input type="text" name="cyfra_21_1" value="<?php echo $data_labtest['cyfra_21_1']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>UNIT</label>
								<input type="text" name="cyfra_21_1_unit" value="<?php echo $data_labtest['cyfra_21_1_unit']; ?>" disabled>
							</div>
							<div class="col-md-4 select-input-wrapper">
								<label>REFERENCE VALUE</label>
								<input type="text" name="cyfra_21_1_rf" value="<?php echo $data_labtest['cyfra_21_1_rf']; ?>" disabled>
							</div>
						</div>
					</div>
				<?php } ?>
