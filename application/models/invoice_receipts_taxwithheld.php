<?php 
class Invoice_Receipts_TaxWithheld {

	public static $table_name = "rpc_invoice_receipts_taxwithheld";
	...
	function findSumAmountPaid($params) {
		$sql = " 
			SELECT SUM(price) AS price FROM " . self::$table_name  . "
			WHERE or_id = " . Mapper::safeSql($params['or_id']) . "  
		";
