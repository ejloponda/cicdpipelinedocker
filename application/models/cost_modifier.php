...
class Cost_Modifier {
	...
	public static $table_name = "rpc_cost_modifier";
	...
	public static function generateCostModifierDatatable($params) {
	...
	public static function countCostModifierDatatable($params) {
