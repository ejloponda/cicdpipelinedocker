...
class File_Category {
	...
	public static $table_name = "rpc_module_category_list";
	...
	public static function generatefilecategoryDatatable($params) {
	...
	public static function countfilecategoryDatatable($params) {
