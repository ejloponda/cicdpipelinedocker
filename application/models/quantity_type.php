...
class Quantity_Type {
	...
	public static $table_name = "rpc_quantity_types";
	...
	public static function generateQuantityDatatable($params) {
	...
	public static function countQuantityDatatable($params) {
