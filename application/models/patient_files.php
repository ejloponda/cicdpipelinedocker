<?php 
class Patient_Files {
	public static $table_name = "rpc_patient_files";
	...
	function findAllByPatientIdCategory($params) {
		$sql = " 
			SELECT " . field_injector($fields) . " FROM " . self::$table_name  . "
			WHERE patient_id = " . Mapper::safeSql($params['patient_id']) . " AND category_id = " . Mapper::safeSql($params['category_id']) . "
			ORDER BY description, date_created DESC
		";
